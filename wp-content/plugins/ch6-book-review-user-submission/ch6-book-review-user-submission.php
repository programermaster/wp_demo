<?php
/*
Plugin Name:Chapter 6 – Book Review Submission
...
// Display all book types
        ...
        <tr>
            <td>Re-type the following text<br />
                <img src="<?php echo plugins_url('EasyCaptcha/easycaptcha.php', __FILE__ ); ?>" /></td>
...
//This hook is executed early in the WordPress processing sequence.
...
// Only send e-mails for user-submitted book reviews
    if ( isset( $_POST['ch6_brus_user_book_review'] ) && 'book_reviews' == $post->post_type ) {
        ...
        $email_title = htmlspecialchars_decode( get_bloginfo(), ENT_QUOTES ) . " - New Book Review Added: " . htmlspecialchars( $_POST['book_title'] );
// Send e-mail
