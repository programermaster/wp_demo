<?php
/*
Plugin Name:Chapter 10 – hello world translate
...
function ch10hw_config_page() {
    ...
    <form method="post" action="admin-post.php">
        <input type="hidden" name="action" value="save_ch10hw_options" />
    <?php wp_nonce_field( 'ch10hw' ); ?>
        <!-- Echo translation for "Hello World" to the browser -->
        <?php _e( 'Default Text', 'ch10hw_hello_world' ); ?>:
        <input type="text" name="default_text" value="<?php echo esc_html( $options['default_text']); ?>"/>
        <br />
