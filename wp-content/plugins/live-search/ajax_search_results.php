 ...
 *
 * @return string
Either return nothing (i.e. no results) or return
...
$container = array('content'=>''); // define the container's onlyplaceholder
 ...
 * @return
string
Placeholders corresponding to the keys of the
