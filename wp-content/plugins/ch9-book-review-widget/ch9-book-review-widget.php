...
// Only allow numeric values
        if ( is_numeric ( $new_instance['nb_book_reviews'] ) ) $instance['nb_book_reviews'] = intval( $new_instance['nb_book_reviews'] );
        else
...
// Preparation of query string to retrieve book reviews
            $query_array = array('post_type' => 'book_reviews', 'post_status' => 'publish', 'posts_per_page' => $nb_book_reviews);
